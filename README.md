...
- **Droid grid** — all 317 known droids across DEFAULT / GOLD / DIAMOND / RAINBOW / BESKAR tiers
...
- **Rebirth tracker** — shows credit cost and required droids for each rebirth level (0→27); highlights missing droids in the grid
